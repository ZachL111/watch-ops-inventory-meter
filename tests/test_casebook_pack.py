"""Regression checks for the watch-ops-inventory-meter casebook."""
...
from casebook.harness import assert_expected, watch_ops_inventory_meter_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_ops_inventory_meter_summary(), assert_expected())
