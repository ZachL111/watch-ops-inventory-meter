...
watch-ops-inventory-meter is a JavaScript project for automation. It focuses on this technical goal: Develop a JavaScript command-oriented project for inventory scenarios with safe and unsafe fixtures, remediation hints, and no production deployment claims.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 159, risk penalty 7, latency penalty 2, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
